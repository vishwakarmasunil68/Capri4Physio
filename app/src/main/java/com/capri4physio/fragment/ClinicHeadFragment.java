 ...
 * Use the {@link ClinicHeadFragment#newInstance} factory method to
 ...
 * @since   2016-03-31
 */
public class ClinicHeadFragment extends BaseFragment {
     ...
     */
    public static ClinicHeadFragment newInstance() {
        ClinicHeadFragment fragment = new ClinicHeadFragment();
        return fragment;
    }

    public ClinicHeadFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_view_clinic, container, false);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AddClinicBranchHead fragment = AddClinicBranchHead.newInstance();
        ...
        manage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), ViewClinic.class));
            }
        });
