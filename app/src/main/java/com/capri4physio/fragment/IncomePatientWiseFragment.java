...
import com.capri4physio.adapter.adapter.IncomePatientAdapter;
...
public class IncomePatientWiseFragment extends Fragment implements WebServicesCallBack {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            new WebServiceBase(nameValuePairs, getActivity(), this, GET_ALL_INCOMES).execute(ApiConfig.GET_INCOME_PATIENT_WISE);
    ...
    public void parseAllInvoices(String response) {
        ...
        try {
            ...
            if (invoicePOJO.getSuccess().equals("true")) {
                IncomePatientAdapter invoiceAdapter = new IncomePatientAdapter(getActivity(), invoicePOJO.getIncomeResultPOJOList());
