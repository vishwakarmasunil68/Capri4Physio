...
public class FragementActi14 extends FragmentActivity {
	ViewPager Tab;
    TabPagerAdapter14 TabAdapter;
	ActionBar actionBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.acti_main14);

        TabAdapter = new TabPagerAdapter14(getSupportFragmentManager());
