...
public class UsersAdapterProgres_Notes extends RecyclerView.Adapter<UsersAdapterProgres_Notes.MyViewHolder> {
    Boolean flag=false;
    ...
    public UsersAdapterProgres_Notes(List<InfoApps> moviesList, Context ctx, CoordinatorLayout mSnackBarLayout) {
...
//        String date=movie.getNumber();
        ...
        holder.mImgAttachemnt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                posn = ProgressNotesFragment.contactDetails1.get(position).toString();
                contents = ProgressNotesFragment.contactDetails1.get(position).getName().toString();
                note_iid = ProgressNotesFragment.contactDetails1.get(position).getSend_date().toString();
                ...
                dialog.setTitle("Edit - progress note");
    ...
    private void getpnotes(final TextView textView){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiConfig.EDIT_PROGRESS_NOTES  ,
...
//                        Toast.makeText(StmtActivity.this,error.toString(),Toast.LENGTH_LONG).show();
            ...
            protected Map<String,String> getParams(){
                ...
                objresponse.put("moter_exam_progressdesc", casedesc);
                objresponse.put("moter_exam_progress_id", note_iid);
                return objresponse;
            }
    ...
    private void delepnotes(final InfoApps textView){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiConfig.DELETE_PROGRESS_NOTES  ,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
