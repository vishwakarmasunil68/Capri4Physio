 ...
 */
public class RemarksFragment extends BaseFragment implements HttpUrlListener, ViewItemClickListener<MotorItem> {

    private RecyclerView mRecyclerView;
    private CoordinatorLayout mSnackBarLayout;
    public static ArrayList<InfoApps> contactDetails1;
    ListView listView;
    private UsersAdapterRemark_Notes mAdapter;
     ...
     */
    public static RemarksFragment newInstance(String patientId, String assessmentType) {
...
//        startActivity(new Intent(getActivity(),AddMotorExamFragment.class));
        ...
        AddRemarksFragment addRemarksFragment = AddRemarksFragment.newInstance(patientId,assessmentType);
        ft.replace(R.id.fragment_container, addRemarksFragment);
        ft.addToBackStack(null);
        ft.commit();
    }

    private void getpnotes(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiConfig.GET_REMARKS_NOTES,
...
//                            Toast.makeText(getActivity(),"success", Toast.LENGTH_LONG).show();
                            ...
                            if (success.equals("true")){
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String moter_exam_casedate = jsonObject.getString("moter_exam_remarkdate");
                                    String moter_exam_casedesc = jsonObject.getString("moter_exam_remarkdesc");
                                    String moter_exam_case_id = jsonObject.getString("moter_exam_remark_id");
                                ...
                                mAdapter = new UsersAdapterRemark_Notes(contactDetails1, getActivity(),mSnackBarLayout);
