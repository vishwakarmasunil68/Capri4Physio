...
public class Ios1 extends Fragment {
	public static TextView textView1,textView2,textView3,textView4,textView5,textView6,textView7,textView8,textView9,textView10,textView11,textView12,textView13,textView14,
			textView15,textView16,textView17,textView18,textView19,textView20,textView21,textView22,textView23,textView24,textView25,textView26,textView27;
	 @Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	            Bundle savedInstanceState) {
	 
	        View ios = inflater.inflate(R.layout.ios_frag1, container, false);
		 ...
		 textView22=(TextView)ios.findViewById(R.id.TextView155);
		 textView23=(TextView)ios.findViewById(R.id.TextView166);
		 textView24=(TextView)ios.findViewById(R.id.spinner14);
		 textView25=(TextView)ios.findViewById(R.id.spinner15);
		 textView26=(TextView)ios.findViewById(R.id.TextView22);
		 textView27=(TextView)ios.findViewById(R.id.TextView23);
	        return ios;
}}
