 ...
 */
public class AddPhysiotheraputicFragment extends BaseFragment implements HttpUrlListener
{
    ...
    public static AddPhysiotheraputicFragment newInstance(String patientId, String assessmentType) {
        AddPhysiotheraputicFragment fragment = new AddPhysiotheraputicFragment();
    ...
    public AddPhysiotheraputicFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_add_physiotheraputuic, container, false);
        initView(rootView);
        setListener();
        return rootView;
    }
