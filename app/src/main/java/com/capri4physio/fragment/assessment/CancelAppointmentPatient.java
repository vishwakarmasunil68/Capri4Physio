 ...
 */
public class CancelAppointmentPatient extends AppCompatActivity {
    Viewpatientinlist viewpatientinlist;
    public static EditText patient_name,date,_starttime,booking_reason;
    String booking_Endtime,patient,added_by,patientname,booking_date,booking_starttime,getPatientname,reason,GetDcotorid,uniqueid;
    JSONArray jsonArray;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patient=getIntent().getStringExtra("cancel_no");
        added_by =LocationAdapter.numberrr;
        Log.d("datasl",patient+ added_by);
//        Toast.makeText(getApplicationContext(),patient,Toast.LENGTH_LONG).show();
        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        dialog.setMessage("Please Cancel Appointments Schedule");
...
//                        Toast.makeText(StmtActivity.this,error.toString(),Toast.LENGTH_LONG).show();
            ...
            protected Map<String,String> getParams(){
                ...
                params.put("appointment_branch_code",added_by);
    ...
    private void cancelAppointment(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, CANCEL_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            Toast.makeText(getApplicationContext(), "Appointment request has been canceled successfully.", Toast.LENGTH_LONG).show();
