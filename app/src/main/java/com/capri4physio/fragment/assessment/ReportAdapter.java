...
import com.capri4physio.fragment.ViewReportFragment;
...
//    Log.e("selected", stringArrayList.toString());
        ...
        public int getCount() {
            ...
            return ViewReportFragment.patientaray.size();
        }

        @Override
        public Object getItem(int position) {
            return  ViewReportFragment.patientaray.get(position);
...
//        final ProductBooen p = getProduct(position);
            ...
            textcontac.setText(ViewReportFragment.patientaray.get(position).getName().toString());
...
//                    view.setBackgroundResource(R.drawable.btnselector);
                     numberview=ViewReportFragment.patientaray.get(position).getNumber().toString();
                    String patientname=ViewReportFragment.patientaray.get(position).getName().toString();
                    Intent msglocationintent = new Intent(context, SensoryReport.class);
...
//            edit.setBackgroundResource(R.drawable.btnselector);
            edit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String numberedit=ViewReportFragment.patientaray.get(position).getNumber().toString();
                    String nameedit=ViewReportFragment.patientaray.get(position).getName().toString();
...
//            cancel.setBackgroundResource(R.drawable.btnselector);
            cancel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String numbercancel=ViewReportFragment.patientaray.get(position).getNumber().toString();
                    String nameedit=ViewReportFragment.patientaray.get(position).getName().toString();
