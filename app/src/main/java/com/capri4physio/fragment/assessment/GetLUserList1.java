 ...
 */
public class GetLUserList1 extends AppCompatActivity{
    public static GetLUserList1 getLUserList;
    TextView results;
    LocationAdapter4 contactAdapter;
    public static ArrayList<String> contactDetails;
    InfoApps Detailapp,Detailapp1;
    public static ListView contactList;
    // URL of object to be parsed
    String JsonURL = "http://www.caprispine.in/users/appointmentcancellist";
...
results.setText("Cancel Appoointments");
        if (AppPreferences.getInstance(getApplicationContext()).getUserType().equals("4")){
            spinnerbranchloca.setVisibility(View.VISIBLE);
        }
        else  if (AppPreferences.getInstance(getApplicationContext()).getUserType().equals("0")){
            finish();
            Intent editIntent = new Intent(getApplicationContext(),ApiActivity.class);
...
//                        Toast.makeText(StmtActivity.this,error.toString(),Toast.LENGTH_LONG).show();
            ...
            protected Map<String,String> getParams(){
                ...
                objresponse.put("appointment_branch_code", item);
                return objresponse;
            }
