...
import com.capri4physio.adapter.assessment.TreatmentAdapter;
...
import com.capri4physio.model.assessment.TreatmentModel;
 ...
 * @since 2014-03-31
 */
public class TreatmentFragment extends BaseFragment implements HttpUrlListener, ViewItemClickListener<TreatmentItem> {
     ...
     */
    public static TreatmentFragment newInstance(String patientId, String assessmentType) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mAdapter = new TreatmentAdapter(getActivity(), mList, this);
    }
    ...
    private void addFragment() {
        ...
        AddTreatmentAdviceFragment fragment = AddTreatmentAdviceFragment.newInstance(patientId, assessmentType);
    ...
    private void viewAssessmentApiCall() {
        ...
        if (Utils.isNetworkAvailable(getActivity())) {
            ...
            try {
                ...
                new UrlConnectionTask(getActivity(), ApiConfig.VIEW_ASSESSMENT_URL, ApiConfig.ID1, true, params, TreatmentModel.class, this).execute("");
    ...
    public void onPostSuccess(Object response, int id) {
        ...
        switch (id) {
            case ApiConfig.ID1:
                TreatmentModel model = (TreatmentModel) response;
