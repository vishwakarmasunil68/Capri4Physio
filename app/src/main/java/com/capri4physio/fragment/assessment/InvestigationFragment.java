...
import com.capri4physio.adapter.assessment.InvestigationAdapter;
...
import com.capri4physio.model.assessment.InvestigationModel;
 ...
 * Use the {@link InvestigationFragment#newInstance} factory method to
 ...
 * @since 2014-03-31
 */
public class InvestigationFragment extends BaseFragment implements HttpUrlListener, ViewItemClickListener<InvestigationItem> {
     ...
     */
    public static InvestigationFragment newInstance(String patientId, String assessmentType) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<>();
        mAdapter = new InvestigationAdapter(getActivity(), mList, this);
    }
    ...
    private void addFragment() {
        ...
        AddInvestigationFragment addPainFragment = AddInvestigationFragment.newInstance(patientId, assessmentType);
    ...
    private void viewAssessmentApiCall() {
        ...
        if (Utils.isNetworkAvailable(getActivity())) {
            ...
            try {
                ...
                new UrlConnectionTask(getActivity(), ApiConfig.VIEW_ASSESSMENT_URL, ApiConfig.ID1, true, params, InvestigationModel.class, this).execute("");
    ...
    public void onPostSuccess(Object response, int id) {
        switch (id) {
            case ApiConfig.ID1:
                InvestigationModel model = (InvestigationModel) response;
    ...
    @Override
    public void onViewItemClick(InvestigationItem investigationItem, int position, int actionId) {

        switch (actionId){
            case Constants.ClickIDConst.ID_DELETE_CLICK:
                deleteAlert(investigationItem.getId(),position);

                break;

            case Constants.ClickIDConst.ID_ATTACHMENT_CLICK:
                getFragmentManager().popBackStack();
//                showSnackMessage("No attachment!");
                break;
        }
    }
    @Override
