...
public class UsersAdapterRemark_Notes extends RecyclerView.Adapter<UsersAdapterRemark_Notes.MyViewHolder> {
    Boolean flag=false;
    ...
    public UsersAdapterRemark_Notes(List<InfoApps> moviesList, Context ctx, CoordinatorLayout mSnackBarLayout) {
...
//        String date=movie.getNumber();
        ...
        holder.mImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InfoApps positiin = (RemarksFragment.contactDetails1.get(position));
                 posn = RemarksFragment.contactDetails1.get(position).toString();
                note_iid = RemarksFragment.contactDetails1.get(position).getSend_date().toString();
                delepnotes(positiin);
//                Toast.makeText(ctx, "sgfdkjs"+positiin, Toast.LENGTH_LONG).show();
        ...
        holder.mImgAttachemnt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                posn = RemarksFragment.contactDetails1.get(position).toString();
                contents = RemarksFragment.contactDetails1.get(position).getName().toString();
                note_iid = RemarksFragment.contactDetails1.get(position).getSend_date().toString();
    ...
    private void getpnotes(final TextView textView){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiConfig.EDIT_REMARKS_NOTES  ,
...
//                        Toast.makeText(StmtActivity.this,error.toString(),Toast.LENGTH_LONG).show();
            ...
            protected Map<String,String> getParams(){
                ...
                objresponse.put("moter_exam_remarkdesc", casedesc);
                objresponse.put("moter_exam_remark_id", note_iid);
                return objresponse;
            }
    ...
    private void delepnotes(final InfoApps textView){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiConfig.DELETE_REMARKS_NOTES  ,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
