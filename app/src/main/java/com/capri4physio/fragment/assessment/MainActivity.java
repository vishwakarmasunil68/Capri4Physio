...
public class MainActivity extends AppCompatActivity {
    ...
    private String titles[] = new String[]{"Profile","Chat","Priscription","Medication"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainviwe);
...
//        if (FacebookActivity.profilepicimage!=null){
...
//                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public void setTabs(int count) {
        ...
        ContentFragmentAdapter adapterViewPager = new ContentFragmentAdapter(getSupportFragmentManager(), this, titles);
