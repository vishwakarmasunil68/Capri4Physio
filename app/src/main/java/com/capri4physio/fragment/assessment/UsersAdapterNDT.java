...
public class UsersAdapterNDT extends RecyclerView.Adapter<UsersAdapterNDT.MyViewHolder> {
    private List<NdtResultPOJO> ndtResultPOJOList;
    Dialog dialog;
    Activity activity;
    NdtntpExamFragment ndtntpExamFragment;
    ...
    public UsersAdapterNDT(List<NdtResultPOJO> ndtResultPOJOList, Activity activity, NdtntpExamFragment ndtntpExamFragment) {
        this.ndtResultPOJOList = ndtResultPOJOList;
        this.activity = activity;
        this.ndtntpExamFragment = ndtntpExamFragment;
    }
...
//        String date=movie.getNumber();
        ...
        holder.tv_date.setText(ndtResultPOJOList.get(position).getNtpdate());

        holder.iv_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deleteAlert(position, ndtResultPOJOList.get(position).getNdtid());
            }
        });
        holder.img_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ndtntpExamFragment.ViewNeuroFragment(ndtResultPOJOList.get(position));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        holder.iv_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ndtntpExamFragment.updateNeuroReport(ndtResultPOJOList.get(position));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void delepnotes(final int position, final String ID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ApiConfig.DELETE_NDT_EXAM,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            Log.e("result", response);
                            ndtResultPOJOList.remove(position);
...
//                        Toast.makeText(StmtActivity.this,error.toString(),Toast.LENGTH_LONG).show();
    ...
    public int getItemCount() {
        Log.e("sizepre", String.valueOf(ndtResultPOJOList.size()));
        return ndtResultPOJOList.size();
    }
