...
public class IncomeTherapistWiseFragment extends Fragment implements WebServicesCallBack {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            new WebServiceBase(nameValuePairs, getActivity(), this, GET_ALL_INCOMES).execute(ApiConfig.GET_INVOICE_THERAPIST_WISE);
            ...
            btn_print.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("therapist", therapist_id);
                    String[] start_date = from_date.split("-");
                    String[] end_date = to_date.split("-");
