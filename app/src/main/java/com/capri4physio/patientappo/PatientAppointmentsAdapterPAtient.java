...
public class PatientAppointmentsAdapterPAtient extends RecyclerView.Adapter<PatientAppointmentsAdapterPAtient.MyViewHolder> {
    Boolean flag=false;
...
//            cv = (CardView) view.findViewById(R.id.cv);
    ...
    public PatientAppointmentsAdapterPAtient(List<InfoApps1> moviesList, Activity ctx) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.title.setText(movie.getInvo_date());
...
//        holder.genre.setText(movie.getBill_amount());
        ...
        holder.View.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.cusotm_dialogappooitnments);
                dialog.setTitle("Scheduling - Appointments");

                //adding text dynamically
                TextView patient_name = (TextView) dialog.findViewById(R.id.Patient_name);
                patient_name.setText(movie.getNumber());
                TextView staff_name = (TextView) dialog.findViewById(R.id.Staff_Name);
                staff_name.setText(movie.getInvo_date());
                ...
                bill_number.setText(movie.getAppname());
