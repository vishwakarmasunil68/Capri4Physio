...
public class WebServiceBase extends AsyncTask<String,Void,String> {
    ...
    public WebServiceBase(ArrayList<NameValuePair> nameValuePairs, Activity activity, String msg,View view){
        this.nameValuePairs=nameValuePairs;
        this.activity=activity;
        this.msg=msg;
        this.view=view;
    ...
    public WebServiceBase(ArrayList<NameValuePair> nameValuePairs, Activity activity, Fragment fragment, String msg, boolean isdialog){
        this.nameValuePairs=nameValuePairs;
        this.activity=activity;
        this.msg=msg;
        this.isdialog=isdialog;
