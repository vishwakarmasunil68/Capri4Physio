...
public class WebServiceUploadFragment extends AsyncTask<String, Void, String> {
    String jResult;
    Activity activity;
    Fragment fragment;
    ...
    public WebServiceUploadFragment(MultipartEntity reqEntity, Activity activity, String msg) {
    ...
    public WebServiceUploadFragment(MultipartEntity reqEntity, Activity activity, String msg, boolean isdialog) {
        this.reqEntity = reqEntity;
        this.activity = activity;
        this.msg = msg;
    ...
    public WebServiceUploadFragment(MultipartEntity reqEntity, Activity activity, Fragment fragment, String msg) {
        this.reqEntity = reqEntity;
        this.activity = activity;
        this.msg = msg;
