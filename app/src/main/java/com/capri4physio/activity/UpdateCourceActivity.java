...
public class UpdateCourceActivity extends AppCompatActivity implements WebServicesCallBack, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(courcesResultPOJO!=null){
            et_course_name.setText(courcesResultPOJO.getC_name());
            et_comt.setText(courcesResultPOJO.getC_comt());
            et_from_date.setText(courcesResultPOJO.getC_from_date());
            et_to_date.setText(courcesResultPOJO.getC_to_date());
            et_seat_available.setText(courcesResultPOJO.getC_sheet_available());
            et_showing_seat.setText(courcesResultPOJO.getC_showing_sheet());
        ...
        btn_add_course.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ValidateEdittexts(et_course_name, et_comt, et_from_date, et_to_date, et_seat_available,
                    ...
                    new WebServiceBase(nameValuePairs, UpdateCourceActivity.this, UPDATE_COURCE).execute(ApiConfig.update_course_api);
                } else {
