...
public class IncomePatientAdapter extends RecyclerView.Adapter<IncomePatientAdapter.MyViewHolder> {
    ...
    public IncomePatientAdapter(Activity activity, List<IncomeResultPOJO> horizontalList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tv_name.setText(horizontalList.get(position).getTreaStaffName());
