...
public class UsersAdapterSeession extends RecyclerView.Adapter<UsersAdapterSeession.MyViewHolder> {
    Boolean flag=false;
...
//            cv = (CardView) view.findViewById(R.id.cv);
    ...
    public UsersAdapterSeession(List<InfoApps1> moviesList, Activity ctx) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.View.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.sessiondial);
                dialog.setTitle("Staff Productivity (Session wise)");
                ...
                bill_number.setText(movie.getPro_name());
                TextView bill_amount = (TextView) dialog.findViewById(R.id.Bill_amount);
                bill_amount.setText(movie.getStatus());
                TextView paid_amount = (TextView) dialog.findViewById(R.id.Paid_amount);
                paid_amount.setText(movie.getInvo_date());
                TextView due_amount = (TextView) dialog.findViewById(R.id.Due_amount);
                due_amount.setText(movie.getId());
                TextView setNumber = (TextView) dialog.findViewById(R.id.Pro_name);
                setNumber.setText(movie.getNumber());
                TextView setBill_amount = (TextView) dialog.findViewById(R.id.Pro_quantity);
                setBill_amount.setText(movie.getBill_amount());
                /*
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(ctx, android.R.style.Theme_Material_Dialog);
