...
public class UsersAdapterStaffProfromInvoice extends RecyclerView.Adapter<UsersAdapterStaffProfromInvoice.MyViewHolder> {
    Boolean flag=false;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView date,patient_name,staffname,title,year, genre,txt_patient_mode;
        ...
        public MyViewHolder(View view) {
            ...
            txt_patient_mode = (TextView) view.findViewById(R.id.txt_patient_mode);
            genre = (TextView) view.findViewById(R.id.txt_patient_name);
            date = (TextView) view.findViewById(R.id.txt_patient_date);
            patient_name = (TextView) view.findViewById(R.id.txt_patient_patientname);
            staffname = (TextView) view.findViewById(R.id.txt_patient_staff_name);
        }
    }


    public UsersAdapterStaffProfromInvoice(List<InfoApps1> moviesList, Activity ctx) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_patient_adapte, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.staffname.setText(movie.getStaff_name());
        holder.txt_patient_mode.setText(movie.getStatus());
        holder.patient_name.setText(movie.getName());
