...
public class UsersAdapterIncomeTreatment extends RecyclerView.Adapter<UsersAdapterIncomeTreatment.MyViewHolder> {
    Boolean flag=false;
...
//            cv = (CardView) view.findViewById(R.id.cv);
    ...
    public UsersAdapterIncomeTreatment(List<InfoApps1> moviesList, Activity ctx) {
...
//        holder.genre.setText(movie.getBill_amount());
        ...
        holder.View.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.cusotm_dialog_treatment_wise);
                dialog.setTitle("Treatment - wise");
